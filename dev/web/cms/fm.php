<?php
  ...
  $CONFIG = '{ "lang":"de", "error_reporting":true, "show_hidden":false, "hide_Cols":false, "theme":"light"}';

  define('VERSION', '2.5.0');
  define('APP_TITLE', ':DateiManager');

  $use_auth   = true;
  $auth_users = array(
    'admin' => '$2y$10$/K.hjNr84lLNDt8fTXjoI.DBp6PpeyoJ.mGwrrLuCZfAwfSAGqhOW', //admin@123
    'user' => '$2y$10$Fg6Dz8oH9fPoZ2jJan5tZuv6Z4Kp7avtQ9bDfrdRntXtPeiMAZyGO', //12345
    'patrick' => '$2y$10$xCzkOxbwbbhBLtFoiDBuqezH/tfSGr6bjK0BmgQZ3jibW5OtLXO0y' // 1302
  ...
  $root_path                 = $_SERVER['DOCUMENT_ROOT']."cms/";
  $root_url                  = '';
  ...
  $favicon_path              = '';
  $exclude_items             = array('index.html','index.php','.dir.php','live access.php','MyAdmin.php','PgAdmin.php');
  ...
  $cfg = new FM_Config();
  $lang = isset($cfg->data['lang']) ? $cfg->data['lang'] : 'de';
  ...
  $lang_list = array('en' => 'English', 'de' => 'Deutsch');
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                       ...
                                       <div class="text-center"><h1 class="card-title"><?php echo APP_TITLE; ?></h1></div>
                                    </div>
                                    <hr />
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3"><?php fm_show_message(); ?></div>
                                    <input type="hidden" name="token" value="<?php echo htmlentities($_SESSION['token']); ?>" />
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-success btn-block w-100 mt-4" role="button"><?php echo lng('Login'); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="card mb-2 fm-upload-wrapper <?php echo fm_get_theme(); ?>">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item"><a class="nav-link active" href="#fileUploader" data-target="#fileUploader"><i class="fa fa-arrow-circle-o-up"></i> <?php echo lng('UploadingFiles') ?></a></li>
                    <li class="nav-item"><a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> Upload from URL</a></li>
                </ul>
            </div>
            <div class="card-body">
                <p class="card-text">
